...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, num_classes=2, **kwargs):
        ...
        configf=config
        update_config(configf,'./models/hrnet_voc.yaml')
        extra = configf.MODEL.EXTRA
        super(HighResolutionNet, self).__init__()
        ALIGN_CORNERS = configf.MODEL.ALIGN_CORNERS
        print('ALIGN ',ALIGN_CORNERS)
        # stem net
        ...
        ocr_mid_channels = configf.MODEL.OCR.MID_CHANNELS
        ocr_key_channels = configf.MODEL.OCR.KEY_CHANNELS
        ...
        #self.init_weights(configf.MODEL.PRETRAINED)
    ...
    def set_mean_std(self, m,s,cuda=True):
        if cuda:
